...
db.restaurants.find({borough:"Bronx"}, {restaurant_id: 1, name: 1, borough: 1, _id: 0}).limit(5).skip(5)
...
db.restaurants.find({'address.coord.0': {$lt: -95.754168}}, {restaurant_id: 1, name: 1, borough: 1, _id: 0 })
...
db.restaurants.find({borough: "Bronx", cuisine: {$in:["American" , "Chinese"]}}, {restaurant_id: 1, name: 1, borough: 1, _id: 0})
...
// 21 Escriu una consulta per trobar el restaurant_id, name, borough i cuisine per a aquells restaurants que preparen peix excepte 'American' i 'Chinees' o el name del restaurant comença amb lletres 'Wil'.????peix
db.restaurants.find({ $and: [{ name: {$not: /^Wil/} }, { cuisine: 'Seafood' }, { cuisine: { $nin: ["American", "Chinese"] } }]}, { restaurant_id: 1, name: 1, borough: 1, cuisine: 1, _id: 0 })
...
db.restaurants.find({"address.street": ""}, {restaurant_id:1, name: 1, address:1})
